...
public final class URI {
    ...
    public static class Builder {
        ...
        public Builder paramString(String query) {
            ...
            return params(NetUriUtils.parseQueryString(query));
        }
    ...
    public URI(String protocol, String username, String password, String host, int port, String path,
        ...
        ip = NetUriUtils.getIpByHost(host);
    }
    ...
    public URI addParameterString(String query) {
        ...
        return addParameters(NetUriUtils.parseQueryString(query));
    }
    ...
    public String getServiceName() {
        String serviceName = getParameter(Constants.SERVICE_KEY);
        if (StringUtils.isEmpty(serviceName)) {
            serviceName = getParameter(Constants.INTERFACE_KEY);
        }
        return serviceName;
    }
