...
public class Constants {
    ...
    /**
     * Generic Key, used in stargate protocol support Starlight Client TO generic call TO stargate server
     */
    public static final String GENERIC_KEY = "generic";

    /**
     * Stargate uuid, used in stargate protocol support stargate Client TO call TO starlight server
     */
