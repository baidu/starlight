...
public class ShuttingDownEvent {
    ...
    public ShuttingDownEvent(Long shuttingDownTime) {
        this.shuttingDownTime = shuttingDownTime;
    }
    ...
    public Long getShuttingDownTime() {
        return shuttingDownTime;
    }

    public void setShuttingDownTime(Long shuttingDownTime) {
        this.shuttingDownTime = shuttingDownTime;
    }
}
