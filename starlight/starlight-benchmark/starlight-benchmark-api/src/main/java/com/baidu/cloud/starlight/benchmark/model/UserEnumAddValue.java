 ...
 */
public class UserEnumAddValue {

    private long userId;

    private SexAdd sex; // sex add value
    ...
    public SexAdd getSex() {
        return sex;
    }

    public void setSex(SexAdd sex) {
        this.sex = sex;
    }
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("UserAddMiddle{");
