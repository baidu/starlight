...
/**
 * Migrate from Stargate to support RpcBizException
 * 
 * Service Bussiness Exception 上层服务抛出异常根节点
 * 
...
public class RpcBizException extends RpcException {
    ...
    public RpcBizException(String msg) {
        super(msg);
    }

    public RpcBizException(String msg, Throwable cause) {
        super(msg, cause);
    }
