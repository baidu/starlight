...
/**
 * 适配Java生态，用于传输标准C版Brpc协议不支持，但Java生态里需要存在的meta Created by liuruisen on 2021/5/12.
 */
public class StarlightResponseMeta {

    /**
     * 仅用于传输servRecvReqTime / servCost / servExecMethod / tid 标准Brpc协议response meta中不能传输kv attach信息，
     *
     */
