...
import com.baidu.brpc.example.standard.proto3.EchoService;
...
/**
 * Created by MrKingHH on 2019/7/21.
 */
public class EchoServiceImpl implements EchoService {
    private static final Logger LOG = LoggerFactory.getLogger(EchoServiceImpl.class);

    @Override
    public Echo3.EchoResponse echo(Echo3.EchoRequest request) {
        ...
        Echo3.EchoResponse response = Echo3.EchoResponse.newBuilder()
                .setMessage(message)
