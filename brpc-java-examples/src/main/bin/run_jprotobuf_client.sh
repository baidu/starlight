...
if [[ $# != 2 ]]; then
    printf "Usage:\n"
    printf "\tsh run_jprotobuf_client.sh <server-address> <thread-num>\n"
    printf "Sample:\n"
...
JVM_OPTIONS=" -server -Xmn2g -Xmx6g -Xms6g -Xss256k -Xverify:none \
 ...
 -XX:+PrintGCDetails  -XX:+PrintGCTimeStamps -Xloggc:./logs/jprotobuf_client_gc.log "

CUSTOM_CLASSPATH="target/classes:target/test-classes:target/dependency/* "

MAIN_CLASS="com.baidu.brpc.example.jprotobuf.BenchmarkTest"
