...
public class StarlightServerLifecycleAutoConfiguration {
    ...
    public StarlightServerLifecycle starlightServerLifecycle(StarlightServer starlightServer,
        StarlightRegisterListener starlightRegisterListener, ApplicationContext applicationContext) {
