...
public class ClusterLogUtils {
    ...
    public static void logOutlierInstanceEject(Logger logger, String clientName, Server server, PeerStatus status) {
        ...
        logger.info("[OUTLIER] Outlier instance eject: " + "remoteName {}, instance {}, outlierTime {}, reason {}",
            clientName, server.getHostPort(), status.getStatusRecordTime(), outlierReason);
    }
    ...
    public static void logOutlierRecoverySucc(Logger logger, String clientName, Server server, String recoveryReason,
        Integer lastEjectTime) {
        logger.info("[OUTLIER] Outlier recover succ: remoteName {}, instance {}, reason {}, lastEjectTime {}s",
            clientName, server.getHostPort(), recoveryReason, lastEjectTime);
    }

    public static void logOutlierRecoveryFail(Logger logger, String clientName, Server server, String failReason,
        ...
        logger.info(
            ...
            clientName, server.getHostPort(), failReason, lastEjectTime, nextEjectTime);
    }
