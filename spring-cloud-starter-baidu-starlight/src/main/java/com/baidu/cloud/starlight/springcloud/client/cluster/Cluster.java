...
/**
 * Cluster and subset cluster manager
 * 管理集群的相关行为，如集群lb策略、outlier、超时
...
public interface Cluster {
    ...
    /**
     * Dynamically update cluster's config
    ...
    /**
     * Executing requests in sub-clusters, 
     * the sub-cluster can execute its own special logic， such as outlier
     *
     * @param request
     * @param callback
     */
