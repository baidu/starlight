...
/**
 * Starlight LoadBalancer interface
 * 实现类可为Ribbon，也可为springcloudloadbalancer，或者统一为springcloudLoadBalancer
...
public interface LoadBalancer {
     ...
     * @param callback
     */
    void execute(ClusterSelector clusterSelector, SingleStarlightClient starlightClient,
